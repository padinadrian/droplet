...
void InitializeLevel2(Level* level_ptr)
{
    ...
    gateswitches[1].trigger_state = SWITCH_OFF;
    gateswitches[2].switch_index = 2;
    gateswitches[2].trigger_state = SWITCH_OFF;
    gateswitches[3].switch_index = 3;
    gateswitches[3].trigger_state = SWITCH_ON;
    ...
    gates[2].switches = &gateswitches[2];
    gates[2].num_switches = 2;
    gates[3].switches = &gateswitches[2];
    gates[3].num_switches = 2;

    gates[4].switches = &gateswitches[0];
    gates[4].num_switches = 4;
    gates[5].switches = &gateswitches[0];
