...
typedef enum {
    ...
    SPRITE_DROPLET_16_NORMAL_TL   = 8,
    SPRITE_DROPLET_16_NORMAL_BL,
    SPRITE_DROPLET_16_NORMAL_TR,
    SPRITE_DROPLET_16_NORMAL_BR,

    /* Droplet, 16x16, squatting, facing right  */
    SPRITE_DROPLET_16_SQUAT_TL    = 12,
    SPRITE_DROPLET_16_SQUAT_BL,
    SPRITE_DROPLET_16_SQUAT_TR,
    SPRITE_DROPLET_16_SQUAT_BR,
    ...
    SPRITE_DROPLET_16_DEATH_STATE_2_BL  = 52,
    SPRITE_DROPLET_16_DEATH_STATE_2_BR  = 54,

    /* Droplet Death, 16x16, state 3  */
    SPRITE_DROPLET_16_DEATH_STATE_3_BL  = 53,
    SPRITE_DROPLET_16_DEATH_STATE_3_BR  = 55,
